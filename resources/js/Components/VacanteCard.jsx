...
function VacanteCard({ data }) {
    ...
    return (
        <>
            <div className="relative md:w-1/4 w-full rounded overflow-hidden shadow-lg">
                ...
                <div className="absolute top-10 right-0 p-5 cursor-pointer hover:scale-125 ease-in duration-300">
                    <a href={route("Vacantes.update.get", { id: data.id })}>
                        <svg
